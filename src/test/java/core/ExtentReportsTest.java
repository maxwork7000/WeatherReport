...
//    	   Assert.assertEquals("This element on the page", Common.isThisElementOnPage(By.className(info.getProperty("el_10")))); //Depends from part of the day
		Assert.assertEquals("This element on the page",
				Common.isThisElementOnPage(By.xpath(info.getProperty("el_11"))));
		Assert.assertEquals("This element on the page",
				Common.isThisElementOnPage(By.xpath(info.getProperty("el_12"))));
//    	   Assert.assertEquals("This element on the page", Common.isThisElementOnPage(By.xpath(info.getProperty("el_13")))); //Works only when so hot or so cold
		Assert.assertEquals("This element on the page",
...
//    	   Assert.assertEquals("This element on the page", Common.isThisElementOnPage(By.xpath(info.getProperty("el_31"))));
//    	   Assert.assertEquals("This element on the page", Common.isThisElementOnPage(By.xpath(info.getProperty("el_32"))));
//    	   Assert.assertEquals("This element on the page", Common.isThisElementOnPage(By.xpath(info.getProperty("el_33"))));
		Common.scrollDown2();
		Assert.assertEquals("This element on the page",
		...
		Common.scrollDown();
//    	   Assert.assertEquals("This element on the page", Common.isThisElementOnPage(By.xpath(info.getProperty("el_36"))));
//   		   Common.scrollDown2();
		Assert.assertEquals("This element on the page",
